# U-Net implementation modified from https://github.com/mateuszbuda/brain-segmentation-pytorch
...
class UNet2d(nn.Module):
    def __init__(self, in_channels=30, out_channels=3, init_features=32):
        super().__init__()
